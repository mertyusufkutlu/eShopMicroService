...
public class EventBusRabbitMQ : BaseEventBus
{
    ...
    public override void Publish(IntegrationEvent @event)
    {
        ...
        policy.Execute(() =>
        {
            var prop = consumerChannel.CreateBasicProperties();
            prop.DeliveryMode = 2;
    ...
    public override void Subscribe<T, TH>()
    {
        ...
        if (!SubsManager.HasSubscriptionsForEvent(eventName))
        {
            ...
            consumerChannel.QueueDeclare(queue: GetSubName(eventName), // Ensure que exist while consuming
                durable: true,
                exclusive: false,
                autoDelete: false,
                arguments: null);
    ...
    private async void Consumer_Recevied(object? sender, BasicDeliverEventArgs e)
    {
